...
export default function LinksSection({ initialLinks }: LinksSectionProps) {
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <a
                    ...
                    className="text-sm text-zinc-500 hover:text-zinc-800 truncate block transition-colors"
                  >
                    {link.url}
                  </a>
                </div>
